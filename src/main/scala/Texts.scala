object Texts {
  ...
  val prolongations:Array[String] =
    Array(
  ...
  val computeIncome:Array[String] =
    Array(
  ...
  val addEstateTxts:Array[String] =
    Array(
  ...
  val wrongInput:Array[String] = Array(
